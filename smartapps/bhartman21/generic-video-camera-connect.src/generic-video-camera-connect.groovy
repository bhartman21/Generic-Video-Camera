...
*
*  This app was created by Patrick Stuart, but I modified it to use my GITHub account as the namespace.
*/
definition(
    ...
    page(name: "mainPage", title: "Existing Camera", install: true, uninstall: true) {
        if(state?.installed) {
            section("Add a New Camera") {
                app "Generic Video Camera Child", "bhartman21", "Generic Video Camera Child", title: "New Camera", page: "mainPage", multiple: true, install: true
            }
        } else {
